                ...
                <div class="container mt-1">
                    ...
                    <table class="table table-bordered  align-vertical">
                        <thead class="bg-gradient-success">
                            ...
                            <th scope="col" class="text-center" >Test Description</th>
                            <th scope="col" class="text-center">Add Result</th>
                            <th scope="col" class="text-center">Print Result</th>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td><a class="nav-link" href="">Add Result</a></td>
                                <td><a class="nav-link" href="">Print Result</a></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td >Anti DS DNA, BLOOD GROUPING & RH FACTOR</td>
                                <td><a class="nav-link" href="">Add Result</a></td>
                                <td><a class="nav-link" href="">Print Result</a></td>
                            </tr>
                            <tr>
