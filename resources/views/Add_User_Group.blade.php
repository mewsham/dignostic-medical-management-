...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        <div class="container bg-gradient-info border border-width-1 border border-info ">

            <p class="text-info h4">User Groups</p>
        ...
        <section class="content">
            ...
            <div class="container mt-3">
                <form action="{{ route('usergroup') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
                            <label for="User-Group-Name">User Group Name : </label>



                            <input type="text" id="User-Group-Name" name="usergroup" class="form-control-md w-50"
                                placeholder="enter......">
                        </div>
                        <div class="col">
                            ...
                            <input type="text" id="addedby" name="addedby" class="form-control-md w-50"
                                placeholder="enter......">
                        </div>
                        <div class="col">
