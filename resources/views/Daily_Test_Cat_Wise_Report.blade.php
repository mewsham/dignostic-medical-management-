...
<head>
    ...
    <title>doctorwisetestcategoryincome</title>
            ...
            <section class="content">
                <div class="container mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <table class="table table-bordered">
                                <thead  class="bg-gradient-success">
                                    ...
                                    <th scope="col" colspan="9">Test Category</th>
                                    <!-- <th></th>
                                    <th></th> -->
                                    <th scope="col" >Quantity</th>
                                    <th scope="col">Total Amount</th>
                                    <tr>
                                    <th scope="col" colspan="11" class="text-center h4">Pathology</th>
                                    ...
                                    <tbody class="table-light">
                                      <tr >
                                        <td colspan="9">Urine Analyse</td>
                                        <td>1</td>
                                        <td>800</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">Anti DS DNA</td>
                                        <td>1</td>
                                        <td>2000</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">Fasting Lipid Profile</td>
                                        <td>1</td>
                                        <td>1000</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">Blood Grouping & RH Factor</td>
                                        <td>1</td>
                                        <td>100</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">RA Test</td>
                                        <td>1</td>
                                        <td>250</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">S.cholesterol</td>
                                        <td>1</td>
                                        <td>350</td>
                                       </tr>
                                       <tr >
                                        <td colspan="9">RBS With CUS</td>
                                        <td>1</td>
                                        <td>120</td>
                                       </tr>
                                       <tr >
                                       ...
                                       <tr><th scope="col" colspan="11" class=" h4 text-center bg-gradient-success ">USG</th></tr>
                                       <tr >
                                        <td colspan="9">USG - L/A</td>
                                        <td>1</td>
                                        <td>700</td>
                                       </tr>
                                       <tr >
                                       ...
                                       <tr><th scope="col" colspan="11" class="h4  text-center bg-gradient-success ">X-RAY</th></tr>
                                       <tr >
                                        <td colspan="9">X-ray Lt Elbow Joint B/V</td>
                                        <td>1</td>
                                        <td>400</td>
                                       </tr>
                                       <tr >
                        ...
                        <div class="col-5  m-md-auto " style="display: flex;  justify-content:center;">
