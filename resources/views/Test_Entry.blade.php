        ...
        <section class="content">
            <div class="container mt-3">
                ...
                <div class="card card-success">
                    ...
                    <form action="{{ route('TestEntry') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group card-body">
                            ...
                            <select name="testcategory" id="testcategory">
                                ...
                                <option value="Mtscan">MTscan</option>
                            ...
                            <div class="row mt-4">
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" placeholder=".col-3" name="name">
                                </div>
                                <div class="col-4">
                                    <label for="exampleInputEmail1">Price</label>
                                    <input type="text" class="form-control" placeholder=".col-4" name="price">
                                </div>
                                <div class="col-4">
