...
<head>
    ...
    <title>Test Category Entry</title>
                ...
                <div class="container mt-3">
                    <div class="container border border-width-1 border-info">
                             ...
                             <div class="row">
                                   ...
                                   <label for="Main-Test-Category"> Category:   </label>
                                   <select class="custom-select-md w-25  form-control-md"  id="Main-Test-Category" value="Select Test-Category" placeholder="Select Purpose">Select test category
                                       <option>
                                         Pathology
                                       </option>
                                       <option>
                               ...
                               <div class="row mt-5">
                                ...
                                <input class=" w-25  form-control"  id="Test-Category" value="" placeholder="enter.......">
                               </div>
                               <div class="row mt-5">
                                <label for="Test-Category-report-format">Test Category Report Formate:   </label>
                                <div class="input-group mb-3">
                                    <div class="office-toolbar">
                                        <button class="btn btn-light" id="boldBtn">
                                          <i class="fas fa-bold"></i> Bold
                                        </button>
                                        <button class="btn btn-light" id="italicBtn">
                                          <i class="fas fa-italic"></i> Italic
                                        </button>
                                        <button class="btn btn-light" id="underlineBtn">
                                      ...
                                      <div class="content w-100">
                                        ...
                                        <p  id="editableContent" class="w-100" contenteditable="true">Start typing here...</p>
                                      </div>
                                    </div>
