                    ...
                    <div class="row">
                        <table class="table table-bordered bg-gradient-success">
                            <thead  class="bg-gradient-success">
                                ...
                                <th scope="col" class="text-center">Income Description</th>
                                <th scope="col" class="text-center">Amount(TK)</th>

                                <th scope="col" class="text-center">SL.NO.</th>
                                <th scope="col" class="text-center">Expenses Description</th>
                                <th scope="col" class="text-center">Amount(TK)</th>
                                </tr>
                                ...
                                <tbody>
                                  ...
                                  <tr class="bg-gradient-success">
                                    ...
                                    <td colspan="3" class="text-center">Today's Balance</td>
                                    <!-- <td ></td>
                                    <td></td> -->

                                    <td colspan="3" class="text-center">0(TK)</td>
                                    <!-- <td></td>
                                    <td ></td> -->
                                    <!-- <td ></td> -->
