    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container mt-3 border border-width-2 border-dark">
                ...
                <td colspan="2" >
                        ...
                        <select class="custom-select-md form-control-md  " >
                            <option>
                                All
                            </option>
                ...
                <td colspan="2">
                    <div   style="display: flex;justify-content: left;align-items: start;">
                            ...
                            <button type="submit" id="table-submission" class="btn btn-primary">Show</button>
                    ...
                    <table class="table table-bordered">
                        <thead  class="bg-gradient-success">
                            ...
                            <th scope="col" class="text-center">Given Discount</th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-md-right" colspan="3">Total</td>
                                    <td colspan="2">0</td>
                                    <td>0</td>
                                </tr>
                            </tbody>
