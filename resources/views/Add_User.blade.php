            ...
            <div class="container mt-3">
                ...
                <form action="{{ route('adduser') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="User-Name" class="ml-2">User Name :</label>
                        <input type="text" id="User-Name" class="form-control-md ml-4 " name="username"
                            placeholder="enter......">
                    </div>
                    <div class="col-4 form-group">
                        <label for="User-password">User Password :</label>
                        <input type="text" id="User-Password" class="form-control-md" name="userpassword" placeholder="enter......">
                    </div>
                    <div class="col-4">
                        <div class="col">
                            <label for="User-Group">User Group : </label>
                            <select class="custom-select-md  ml-3  form-control-md" id="User-Group"
                                value="Select Purpose" name="usergroup" placeholder="Select Purpose">Select Purpose
                                <option>
                                    choose user group
                                </option>
                                <option>
                    ...
                    <div class="col">
                        <div class="col-5  m-md-auto mt-2" style="display: flex;  justify-content: center;">
                            <a href="User Records.html"><button type="submit" id="table-submission"
