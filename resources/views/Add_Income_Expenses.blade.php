        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container border border-width-1 border-info">
                 ...
                 <div class="row">
                    <div class="col">
                        <label for="Purpose-Name">Purpose Name :   </label>



                        <input  type="text" id="Purpose-Name" class="form-control-md w-50" placeholder="enter......">
                    </div>
                    <div class="col">
                        <label for="Purpose-type">Purpose Type:   </label>
                        <select class="custom-select-md w-50  form-control-md"  id="Purpose-type" value="Select Purpose" placeholder="Select Purpose">Select Purpose
                            <option>
                               Expense
                            </option>
                            <option>
                ...
                <div class="container border border-width-1 border-info">
                    <table class="table table-bordered border border-width-2 border-dark table-responsive{-sm|-md|-lg|-xl|-xxl}      ">
                        <thead  class="bg-gradient-info">
                       
                           
                            <tr>
                                <th scope="col" class="text-center" colspan="4">Name</th>
                                <th scope="col" class="text-center" colspan="4">Purpose Type</th>
                             </tr>
                            ...
                            <tbody >
                              <tr>
                                ...
                                <td class="text-center">Cash Return</td>
                              ...
                              <tr>
                                ...
                                <td colspan="4" class="text-center">ELECTRICTY Bill</td>
                                <td colspan="4" class="text-center">Expense</td>
                            </tr>
                            <tr>
                ...
                <div class="col-5  m-md-auto mt-2" style="display: flex;  justify-content: center;">
                    <a href="#"><button  type="button" id="table-submission" class="btn btn-primary">Print</button></a>
                 </div> 
                </div>
