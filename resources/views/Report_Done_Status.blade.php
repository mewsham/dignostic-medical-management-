...
<head>
    ...
    <title>Report Done Status</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container border border-width-2 border-dark mt-1">

                    <table class="table-bordered bg-gradient-warning w-100">
                        <thead></thead>
                        <tbody>
                            <tr>
                                <td colspan="2"><label for="Date-from">Date From :</label></td>
                                <td colspan="2" >
                ...
                <td colspan="2"><label for="Date-from">Date TO :</label></td>
                <td>
                ...
                <div class="container mt-1 border border-width-2 border-dark">
                    <div class="container-fluid">
                        <p class="text-center h5">Test Report Done Status Report: 01-07-2021 00:00:00 To 01-07-2021 23:59:59</p>
                    </div>
                    <div class="container-fluid">
                    ...
                    <div class="container-fluid" id="report-search-res">
                        <p class="text-center h5">There is no data found with provided filter options</p>
                           </div>
                </div>
