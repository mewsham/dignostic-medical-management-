...
<head>
    ...
    <title>Add Test-Report Format</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container bg-gradient-info border border-width-1 border border-info mt-2">

                    <p class="text-info">wewewpepw</p>

                 </div>
                <div class="container mt-3">
                    <div class="container border border-width-1 border-info">
                        <form action="{{ route('TestEntry') }}" method="post">
                            @csrf
                     <div class="row">
                        <div class="col">
                            <label for="Test-Category">Test Category:   </label>
                            <select class="custom-select-md w-50  form-control-md" name="testcategory" id="Test-Category" value="Select Test-Category" placeholder="Select Purpose">Select test category
                                <option>
                                   Emergency
                                </option>
                                <option>
                        ...
                        <div class="col">
                            <label for="Name" class="ml-5 h5">Name :   </label>



                            <input  type="text" name="name" id="Name" class="ml-5 form-control-md w-50" placeholder="enter......">
                        </div>

                     </div>
                     <div class="row">
                        <div class="col">
                            <label for="Price" class="ml-1 h5">Price:   </label>
                            <input  class=" ml-5 w-50  form-control-md" type="number"  name="price" id="Price" value="Select Purpose" placeholder="980">

                        </div>

                        <div class="col">
                            <label for="referrercommission">Referrer's Commission :   </label>



                            <input  type="number" id="Referrer-Commission" name="referrercommission" class="form-control-md w-50" placeholder="500">
                        </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead  class="bg-gradient-success">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">A.G. Ratio</td>
                                    <td class="text-center">120</td>
                                    <td class="text-center">30</td>
                                    <td class="text-center">Biochemistry</td>
                                    <td class="text-center">
                                        <a class="nav-link  float-left" href="">Edit</a>
                                        <a class="nav-link  float-left" href="">Report</a>
                                        <a class="nav-link float-left" href="">Delete</a>
                                    </td>
            ...
            <p class="text-bold h5">Each page contain 50 Records of the patients for further patients Records click on the next page</p>
            <ul class="pagination justify-content-center ">
                <li class="page-item  text-center h4"><a class="page-link" href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
                <li class="page-item text-center h4"><a class="page-link" href="#">1</a></li>
                <li class="page-item text-center h4"><a class="page-link" href="#">2</a></li>
                <li class="page-item text-center h4"><a class="page-link" href="#">3</a></li>
                <li class="page-item text-center h4"><a class="page-link" href="#">4</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">5</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">6</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">7</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">8</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">9</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#">10</a></li>
                <li class="page-item text-center  h4"><a class="page-link" href="#" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
              </ul>
            <!-- /.content -->
        </div>
