...
Route::get('/oldpatientrecord',[DashboardController::class,'oldpatientrecords'])->name('oldpatientRecord');
...
Route::get('/AddIncomeorExpenses',[PageController::class,'AddIncomeExpense']);
