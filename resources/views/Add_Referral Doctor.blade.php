...
<head>
    ...
    <title>Add Referal Doctor</title>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container bg-gradient-info border border-width-5 h-25 border border-info ">

                <p class="text-info h4">ADD REFERAL DOCTOR</p>

            </div>
            <div class="container mt-3">
                <form action="{{route('addreferraldoctor')}}" method="post">
                    @csrf
                    <div class="col">
                        ...
                        <input type="text" id="doctor-name" name="name" class="ml-5 form-control-md w-50"
                            placeholder="enter......">
                    </div>
                    <div class="col">
                        ...
                        <textarea id="doctor-address" name="address" class=" form-control-lg ml-5 mt-2 w-25" rows="20" cols="20"></textarea>
                    </div>
            ...
            <div class="container mt-3 border border-width-3 border-dark">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>2016-10-25 21:56:51</td>
                            <td>admin</td>
                            <td><a class="nav-link" href="  Edit"><i class="fas fa-edit"></i></a>
                            </td>

                            <td><a class="nav-link" href="View Log"><i class="fa fa-search"
                                        aria-hidden="true"></i></a></td>
                            <td> <a class="nav-link" href="Delete"><i class="fa fa-trash"
                                        aria-hidden="true"></i></a></td>
                        </tr>
                        <tr>
                            <td>2</td>
                        ...
                        <tr>
                            ...
                            <td><a class="nav-link" href="View Log"><i class="fa fa-search"
                                        aria-hidden="true"></i></a></td>
                            <td> <a class="nav-link" href="money"><i class="fa fa-trash"
                                        aria-hidden="true"></i></a></td>
                        </tr>
    ...
    <div class="justify-content-between m-auto">
        <p class="text-bold text-center h5 m-auto">Each page contain 50 Records of the patients for further patients
            Records click on the next page</p>
        <ul class="pagination justify-content-center ">
            <li class="page-item  text-center h4"><a class="page-link" href="#" aria-label="Previous"><span
            ...
            <li class="page-item text-center  h4"><a class="page-link" href="#" aria-label="Next"><span
