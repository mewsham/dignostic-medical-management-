    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                   ...
                   <div class="row">
                    <p class="h4 mt-2"> The User Has Been Saved</p>
                </div>
                    <div class="container border border-width-2 border-dark">

                    <table class="table table-bordered tablee">
                        <div >

                            <p class="text-center border border-width-2 border-dark bg-gradient-success">Page of 1 Showing Records out of total, starting on record 0,ending on last record</p>
                ...
                <hr>
                        ...
                        <thead  class="bg-gradient-success">
                            ...
                            <tr>
                                ...
                                <td>admin</td>
                                <td>admin</td>
                              <td><a class="nav-link" href="  Edit">  Edit
                            </td></a>

                                 <td><a class="nav-link" href="View Log">View Log</a></td>
                                  <td> <a class="nav-link" href="Change Password">Change Password</a></td>
