...
<head>
    ...
    <title>Daily Referral Paid Summary</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container bg-gradient-info border border-width-1 border border-info mt-2">
                    ...
                    <p class="text-Black h4">Daily Referral Paid Summary</p> 
            ...
            <div class="container mt-3">
                <table class="table table-bordered">
                    ...
                    <thead  class="bg-gradient-success">
                        ...
                        <th scope="col" class="text-center">Ref./Doctor</th>
                        <th scope="col" class="text-center">Referral Amount</th>
                        <th scope="col" class="text-center">Referral Payment
                            By
                        </th>
                        <th scope="col" class="text-center">Payment Date</th>
                        <th scope="col" class="text-center">Is Sell</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center" colspan="4">Total Referral Paid</td>
                                <td colspan="4">0</td>
                            </tr>
                        </tbody>
